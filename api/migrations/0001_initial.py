    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('investment_accounts', models.ManyToManyField(related_name='account_users', to='api.investmentaccount')),
        ...
        migrations.AddField(
            ...
            name='users',
            field=models.ManyToManyField(related_name='user_accounts', to='api.user'),
        ),
        migrations.CreateModel(
            name='UserInvestmentAccount',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('VIEW', 'View'), ('FULL CRUD', 'Full CRUD'), ('POST', 'Post')], max_length=10)),
                ('investment_account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.investmentaccount')),
